...
<html>
<head>
<title>Fútbol Sala Cádiz | Jornadas</title>
...
<body> 
	...
	<div class="header-bottom-top">
		...
		<div class="container">
			...
			<% ArrayList<Jornada> n = new ArrayList<Jornada>();%>
    		<% n= (ArrayList<Jornada>) request.getAttribute("jornadas"); %>
			<% for(Jornada j : n){ %>
				<div class="col-xs-12 col-sm-4 contact-left botoni">
						<a href="FormularioResultado?jor=<%=j.getId()%>"><button type="button" class="btn btn-info btn-lg btn-block">Jornada <%=j.getNum()%></button></a>
				</div>
			<% }%>
            </div>
			<div class="clearfix"> </div>
