...
<html>
<head>
<title>Fútbol Sala Cádiz | NuevaNoticia</title>
...
<body>
	...
	<img id="blah" src="" alt="" />
					<form action="CreaNoticia" name="usrform" enctype="multipart/form-data" method="post">
								<input name="titular" type="text" id="titular" placeholder="Titular" required>
								<input name="subtitulo" type="text" id="subtitulo" placeholder="Subtitulo" required>
								<input name="cuerpo" type="text" id="cuerpo" placeholder="Cuerpo" required>
								<input name="fecha" type="date" id="fecha" placeholder="Fecha" required>
								<input name="fichero" id="fichero" type="file" class="upload" onchange="readURL(this);"  required>	
