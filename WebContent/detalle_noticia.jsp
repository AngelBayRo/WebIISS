...
<html>
<head>
<title>Fútbol Sala Cádiz | DetalleNoticia</title>
		...
		<div class="content-app-up">
			...
			<div class="regard-2">
				...
				<div class="regard-in row">
					...
					<div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12"><img class="img-responsive center-block" src="images/pe.jpg" alt=""></div>
				...
				<div class="clearfix">
				  ...
				  <div class="col-xs-4"><%=n.getFecha() %></div>
					...
					<div class="col-xs-4 "><a href="noticias.html"><button type="button" class="boton2" >AtrÃ¡s</button></a></div>
					</div>
