			...
			<div class="header-bottom">			
				...
				<div class="top-nav">
					...
					<ul>
                        ...
                        <li class="active"><a href="FormularioClasificacion" class="scroll">Clasificaci�n</a></li>
                        <li><a href="contact.html" class="scroll">Contacto</a></li>
                        <li ><a href="administracion.jsp" class="scroll">Administraci�n</a></li>
					</ul>
		...
		<div class="container">
			...
			<% for(Categoria s : n){ %>
				<div class="col-xs-12 col-sm-4 contact-left botoni">
						<a href="Clasificacion?cat=<%=s.getId()%>"><button type="button" class="btn btn-info btn-lg btn-block"><%=s.getNombre()%></button></a>
				</div>
			<% }%>
            </div>
			<div class="clearfix"> </div>
