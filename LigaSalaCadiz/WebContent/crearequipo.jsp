...
<html>
<head>
<title>Fútbol Sala Cádiz | CreaEquipo</title>
...
<body> 
	...
	<div class="header-bottom-top">
		...
		<div class="container">
			...
			<h4>Crear Equipo</h4>
			<img id="blah" style="margin:auto;" src="" alt="" class="img-rounded img-responsive" />
			<form action="CreaEquipo" name="usrform" enctype="multipart/form-data" method="post">
				<div class="grid-contact">
					<div class="col-md-12 contact-left">
						<p class="your-para"> Nombre<span>*</span></p>
						<textarea class="form-control" name="nombre" rows="1"  required></textarea>
					</div>
					<div class="col-md-12 contact-left">
						<p class="your-para"> Categoria<span>*</span></p>
					...
					<div class="col-md-12 contact-left">
						<p class="your-para"> Delegado<span>*</span></p>
						<textarea class="form-control" name="delegado" rows="1"  required></textarea>
					</div>
					<div class="col-md-12 contact-left margenes">
						<p class="your-para"> Subir imagen<span>*</span></p>
						<input class="margen" name="fichero" id="fichero" type="file" onchange="readURL(this);"  required>
					</div>
					<div class="col-xs-12 col-sm-4 contact-left">
						<p class="your-para"> Puntos<span>*</span></p>
						<input  type="number" name="puntos"  required></input>
					</div>
					<div class="col-xs-12 col-sm-4 contact-left">
						<p class="your-para"> Goles a favor<span>*</span></p>
						<input  type="number" name="favor" required></input>
					</div>
					<div class="col-xs-12 col-sm-4 contact-left">
						<p class="your-para"> Goles en contra<span>*</span></p>
						<input  type="number" name="contra"  required></input>
					</div>
