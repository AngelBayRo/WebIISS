...
<html>
<head>
<title>Fútbol Sala Cádiz | CreaJornada</title>
...
<body> 
	...
	<div class="header-bottom-top">
		...
		<div class="container">
			...
			<form action="CreaJornada" method="post">
				<div class="grid-contact">
					<div class="col-xs-12 col-sm-4 contact-left">
						<p class="your-para"> Numero de jornada<span>*</span></p>
					...
					<div class="col-xs-12 col-sm-6 contact-left">
						<p class="your-para"> Fecha inicio<span>*</span></p>
						<input  type="date" name="finicio" required></input>
					</div>
					<div class="col-xs-12 col-sm-6 contact-left">
						<p class="your-para"> Fecha fin<span>*</span></p>
						<input  type="date" name="ffin" required></input>
					</div>
					<div class="clearfix"> </div>
				</div>
					<div class="send" style="margin-top:30px">
						<input type="submit" value="Crear Jornada" >
					</div>
					<div class="clearfix"> </div>
			</form>
                </div>
